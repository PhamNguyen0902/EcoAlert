...
import { getCategoryDisplay, getSeverityDisplay, getStatusDisplay } from "./domainI18n";
...
): string => getCategoryDisplay(language, category);
...
export const getWorkflowStatusLabel = (
  status?: string | null,
  language: SupportedLanguage = "en",
): string => getStatusDisplay(language, status);
