...
export const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    "weather.view_details": "Xem chi tiết thời tiết",
    "weather.details": "Chi tiết thời tiết",
    "weather.back_dashboard": "Quay lại Tổng quan",
    "weather.current_conditions": "Điều kiện hiện tại",
    "weather.pressure": "Áp suất",
    "weather.visibility": "Tầm nhìn",
    "weather.hourly_forecast": "Dự báo theo giờ",
    "weather.hourly_forecast_body": "36 giờ tiếp theo, theo giờ địa phương",
    "weather.daily_forecast": "Dự báo 5 ngày",
    "weather.forecast_unavailable": "Dự báo tạm thời không khả dụng. Điều kiện hiện tại vẫn được hiển thị.",
    "weather.details_unavailable": "Không thể tải chi tiết thời tiết",
    "weather.details_unavailable_desc": "Hãy kiểm tra kết nối và thử lại.",
    "weather.location_unavailable": "Chưa xác định được vị trí",
    "weather.location_unavailable_desc": "Không thể xác định vị trí để tải thời tiết.",
    "weather.refresh": "Cập nhật",
    "weather.today": "Hôm nay",
    "weather.unit_kmh": "km/h",
    "weather.unit_km": "km",
    "weather.aqi_unknown": "Chưa rõ",
    "weather.aqi_good": "Tốt",
    "weather.aqi_fair": "Khá",
    "weather.aqi_moderate": "Trung bình",
    "weather.aqi_poor": "Kém",
    "weather.aqi_very_poor": "Rất kém",
    ...
    "incident_density.mode_label": "Chế độ bản đồ",
  ...
  en: {
    ...
    "weather.view_details": "View weather details",
    "weather.details": "Weather details",
    "weather.back_dashboard": "Back to Dashboard",
    "weather.current_conditions": "Current conditions",
    "weather.pressure": "Pressure",
    "weather.visibility": "Visibility",
    "weather.hourly_forecast": "Hourly forecast",
    "weather.hourly_forecast_body": "The next 36 hours, in local time",
    "weather.daily_forecast": "5-day forecast",
    "weather.forecast_unavailable": "Forecast is temporarily unavailable. Current conditions are still shown.",
    "weather.details_unavailable": "Weather details unavailable",
    "weather.details_unavailable_desc": "Check your connection and try again.",
    "weather.location_unavailable": "Location unavailable",
    "weather.location_unavailable_desc": "We could not determine a location for weather.",
    "weather.refresh": "Refresh",
    "weather.today": "Today",
    "weather.unit_kmh": "km/h",
    "weather.unit_km": "km",
    "weather.aqi_unknown": "Unknown",
    "weather.aqi_good": "Good",
    "weather.aqi_fair": "Fair",
    "weather.aqi_moderate": "Moderate",
    "weather.aqi_poor": "Poor",
    "weather.aqi_very_poor": "Very poor",
    ...
    "incident_density.mode_label": "Map mode",
