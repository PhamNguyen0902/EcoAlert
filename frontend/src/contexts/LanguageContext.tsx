...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    // News Section
    "news.title": "Tin tức Môi trường",
    "news.subtitle": "Cập nhật các sáng kiến và cảnh báo môi trường mới nhất",
    "news.view_all": "Xem tất cả tin tức",
    "news.read_more": "Đọc thêm",

    // Weather Widget
    "weather.unavailable": "Không thể lấy thông tin thời tiết",
    "weather.unavailable_desc": "Không thể tải dữ liệu thời tiết hiện tại.",
    "weather.retry": "Thử lại",
    "weather.feels_like": "Cảm giác như",
    "weather.last_updated": "Cập nhật lần cuối",
    "weather.humidity": "Độ ẩm",
    "weather.wind": "Tốc độ gió",
    "weather.air_quality": "Chất lượng không khí",
    "weather.uv_index": "Chỉ số UV",
    "weather.sunrise": "Bình minh",
    "weather.sunset": "Hoàng hôn",
    ...
    "officer_stats.avg_time": "Thời gian xử lý trung bình",
    "officer_stats.completion_rate": "Tỷ lệ hoàn thành",
    ...
    // Officer Stats & Notifications
    "officer_stats.page_title": "Thống kê Hiệu suất",
    "officer_stats.total_handled": "Tổng Báo cáo đã Xử lý",
    "officer_stats.all_time": "Tất cả thời gian",
    "officer_stats.currently_pending": "Đang chờ xử lý",
    "officer_stats.awaiting_verification": "Chờ xác minh",
    "officer_stats.in_progress_desc": "Đang tích cực giải quyết",
    ...
    "incident_density.title": "Mật độ sự cố",
    "incident_density.subtitle": "Theo dõi mật độ và vị trí chính xác của các sự cố môi trường đã báo cáo.",
    "incident_density.category": "Danh mục",
    "incident_density.all_categories": "Tất cả danh mục",
    "incident_density.severity": "Mức độ",
    "incident_density.all_severities": "Tất cả mức độ",
    "incident_density.severity_critical": "Nghiêm trọng",
    "incident_density.severity_high": "Cao",
    "incident_density.severity_medium": "Trung bình",
    "incident_density.severity_low": "Thấp",
    "incident_density.status": "Trạng thái",
    "incident_density.all_statuses": "Tất cả trạng thái",
    "incident_density.status_active": "Đang xử lý",
    "incident_density.status_resolved": "Đã giải quyết",
    "incident_density.status_closed": "Đã đóng",
    "incident_density.from": "Từ ngày",
    "incident_density.to": "Đến ngày",
    "incident_density.map_mode": "Chế độ bản đồ",
    ...
    "incident_density.map_instruction": "Nhấn vào bản đồ để xem sự cố lân cận",
    "incident_density.map_explanation": "Mật độ được tính từ vị trí sự cố GIS thực tế; đây không phải dữ liệu dự báo.",
    "incident_density.load_error": "Không thể tải dữ liệu mật độ sự cố.",
    "incident_density.empty": "Không có sự cố nào khớp với bộ lọc này.",
    "incident_density.operational_summary": "Tóm tắt hoạt động",
    "incident_density.operational_summary_description": "Các bản ghi sự cố GIS thực tế trong bộ lọc hiện tại.",
    "incident_density.total": "Tổng số",
    "incident_density.open": "Đang mở",
    "incident_density.resolved": "Đã giải quyết",
    "incident_density.closed": "Đã đóng",
    "incident_density.by_severity": "Theo mức độ",
    "incident_density.by_category": "Theo danh mục",
    "incident_density.selected_area": "Khu vực được chọn",
    "incident_density.nearby_description": "Các sự cố được báo cáo trong bán kính {radius} m từ vị trí bạn chọn.",
    "incident_density.close": "Đóng",
    "incident_density.no_nearby": "Không tìm thấy sự cố nào xung quanh điểm này.",
    "incident_density.view_incident": "Xem chi tiết sự cố",
    "incident_density.untitled": "Sự cố chưa có tiêu đề",
    "incident_density.unknown_address": "Không có địa chỉ",
    "incident_density.unknown": "Không có dữ liệu",
    "incident_density.reported": "Thời gian",
    "incident_density.address": "Địa chỉ",
    "incident_density.coordinates": "Tọa độ",
  ...
  en: {
    ...
    "weather.unavailable_desc": "Unable to fetch current weather data.",
    "weather.retry": "Retry",
    ...
    // Officer Map & Stats
    "officer_map.layer_title": "GIS Map Layers",
    "officer_map.heatmap": "Pollution Heatmap",
    "officer_map.clusters": "Incident Clusters",
    "officer_map.filter_radius": "Monitoring Radius",
    "officer_stats.sla_title": "SLA Compliance Rate",
    "officer_stats.avg_time": "Average Resolution Time",
    "officer_stats.completion_rate": "Completion Rate",
    ...
    // Officer Stats & Notifications
    "officer_stats.page_title": "Performance Statistics",
    "officer_stats.total_handled": "Total Reports Handled",
    "officer_stats.all_time": "All time",
    "officer_stats.currently_pending": "Currently Pending",
    "officer_stats.awaiting_verification": "Awaiting verification",
    "officer_stats.in_progress_desc": "Actively being worked on",
    ...
    // Admin Incident Density
    "incident_density.title": "Incident Density",
    "incident_density.subtitle": "Monitor density and the exact locations of reported environmental incidents.",
    "incident_density.category": "Category",
    "incident_density.all_categories": "All categories",
    "incident_density.severity": "Severity",
    "incident_density.all_severities": "All severities",
    "incident_density.severity_critical": "Critical",
    "incident_density.severity_high": "High",
    "incident_density.severity_medium": "Medium",
    "incident_density.severity_low": "Low",
    "incident_density.status": "Status",
    "incident_density.all_statuses": "All statuses",
    "incident_density.status_active": "Active",
    "incident_density.status_resolved": "Resolved",
    "incident_density.status_closed": "Closed",
    "incident_density.from": "From",
    "incident_density.to": "To",
    "incident_density.map_mode": "Map mode",
    "incident_density.mode_heatmap": "Heatmap",
    "incident_density.mode_incidents": "Incidents",
    "incident_density.mode_combined": "Combined",
    "incident_density.map_instruction": "Click the map to inspect nearby incidents",
    "incident_density.map_explanation": "Density is calculated from real GIS incident locations; it is not prediction data.",
    "incident_density.load_error": "Unable to load incident density data.",
    "incident_density.empty": "No incidents match these filters.",
    "incident_density.operational_summary": "Operational Summary",
    "incident_density.operational_summary_description": "Real GIS incident records in the current filter set.",
    "incident_density.total": "Total",
    "incident_density.open": "Open",
    "incident_density.resolved": "Resolved",
    "incident_density.closed": "Closed",
    "incident_density.by_severity": "By severity",
    "incident_density.by_category": "By category",
    "incident_density.selected_area": "Selected Area",
    "incident_density.nearby_description": "Reported incidents within {radius} m of your selected location.",
    "incident_density.close": "Close",
    "incident_density.no_nearby": "No incidents were found near this point.",
    "incident_density.view_incident": "View incident details",
    "incident_density.untitled": "Untitled incident",
    "incident_density.unknown_address": "No address available",
    "incident_density.unknown": "Unavailable",
    "incident_density.reported": "Reported",
    "incident_density.address": "Address",
    "incident_density.coordinates": "Coordinates",
