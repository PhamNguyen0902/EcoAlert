...
import {
  ReportFormStepper,
  type ReportStep,
} from "@/components/reports/ReportFormStepper";
...
export default function CreateAlert() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(getErrorMessage(err, t("toast.report_submit_error")), {
        id: "submit",
      });
    } finally {
          ...
          <form onSubmit={(event) => event.preventDefault()}>
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                ...
                {currentStep === 1 ? (
                  <section
                    aria-labelledby="incident-information-heading"
                  ...
                  >
                    <div>
                      ...
                      <h2
                        id="incident-information-heading"
                        className="mt-1 text-2xl font-semibold tracking-tight"
                      >
                        Điều gì đã xảy ra?
                      </h2>
                      <p className="mt-2 text-sm leading-6 text-muted-foreground">
                        Mô tả những gì bạn quan sát thấy để đội ngũ phản ứng có
                        thể hiểu vấn đề trước khi đến.
                      </p>
                    </div>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <p className="mt-1 text-xs leading-5 text-muted-foreground">
                          Sử dụng mô tả ngắn gọn, dễ nhận biết về vấn đề môi
                          trường.
                        </p>
                        <Input
                          id="title"
                      ...
                      <div>
                        <div className="flex items-baseline justify-between gap-3">
                          ...
                          >
                            {t("report_create.field_description")}{" "}
                            <span className="text-destructive">*</span>
                          </Label>
                          <span className="text-xs text-muted-foreground">
                        ...
                        <p className="mt-1 text-xs leading-5 text-muted-foreground">
                          Bao gồm những gì bạn đã thấy, quy mô của sự cố, và bất
                          kỳ rủi ro tức thì nào đối với con người hoặc môi
                          trường.
                        </p>
                        <Textarea
                          id="description"
                ...
                {currentStep === 3 ? (
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-muted-foreground">
                        Hình ảnh rõ nét giúp nhóm hiểu báo cáo và hỗ trợ phân
                ...
                {currentStep === 4 ? (
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-6 text-muted-foreground">
                        Vui lòng xác minh thông tin trước khi gửi. Bạn có thể
                        theo dõi trạng thái báo cáo sau khi gửi.
                      </p>
                    </div>
                    ...
                    <div className="overflow-hidden rounded-xl border divide-y">
                      <section
                        ...
                        aria-labelledby="review-information-heading"
                      >
                        <div className="flex items-center justify-between gap-3">
                          <h3
                            id="review-information-heading"
                            className="font-semibold"
                          >
                            Thông tin sự cố
                          </h3>
            ...
            <div className="mt-8 flex items-center justify-between gap-3 border-t pt-5">
              ...
              {currentStep < steps.length ? (
                ...
                >
                  ...
                  {isSubmitting
                    ? t("report_create.submitting")
                    : t("report_create.submit_confirm")}
                </Button>
              )}
            </div>
          </form>
